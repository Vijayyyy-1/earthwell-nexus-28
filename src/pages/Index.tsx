...
const features = [
  {
    ...
    description:
      "Deep market knowledge exclusively focused on commercial properties.",
  },
  {
    icon: <TrendingUp className="w-8 h-8 text-primary" />,
    title: "Investment Analysis",
    description:
      "Advanced ROI tools and market analysis to maximize your returns.",
  },
  {
    icon: <Users className="w-8 h-8 text-primary" />,
    title: "Dedicated Support",
    description:
      "Personalized service from our team of seasoned CRE professionals.",
  },
  {
    icon: <Award className="w-8 h-8 text-primary" />,
    title: "Proven Results",
    description:
      "15+ years of successful transactions and a portfolio of satisfied clients.",
  },
];
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center relative z-10">
              ...
              <div>
                ...
                <p className="text-lg text-gray-400 mb-10">
                  Let our experts help you discover the ideal opportunity for
                  your business goals. Take the next step today.
                </p>
                  ...
                  <div className="flex items-start gap-4 p-6 bg-white/5 border border-white/10 rounded-lg hover:bg-white/10 transition-colors duration-300">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">
                        View our curated list of exclusive commercial listings.
                      </p>
                    </div>
                ...
                <Link to="/calculator" className="block group">
                  <div className="flex items-start gap-4 p-6 bg-white/5 border border-white/10 rounded-lg hover:bg-white/10 transition-colors duration-300">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">
                        Use our investment tools to project potential returns.
                      </p>
                    </div>
                    <ArrowRight className="w-5 h-5 text-gray-500 ml-auto transition-transform group-hover:translate-x-1 group-hover:text-white" />
                  </div>
